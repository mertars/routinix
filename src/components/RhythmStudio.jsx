    ...
    <div className="fixed inset-0 z-[90] flex flex-col" style={{ background: "var(--bg-app)" }}>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* Tarih şeridi — grid'in üstünde, tam genişlik */}
          ...
          {/* 12 Kolonlu Dashboard Izgarası — mobilde (<lg) tek kolon, masaüstünde (≥lg) 8+4 */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {/* ============ SOL / ANA BÖLÜM — lg:col-span-8 ============ */}
            <div className="lg:col-span-8 flex flex-col gap-6">
              {/* Üst: günün ana başlığı */}
              <div className={CARD}>
                <div className="flex items-center justify-between gap-3 flex-wrap">
                  <div className="text-left">
                    ...
                    <h3 className="text-[19px] font-bold text-[var(--text-primary)]">
                      {isToday ? "Günün ritmine hoş geldin" : "Geçmiş gün özeti"}
                    </h3>
                  </div>
              ...
              {/* Orta: 2x2 Ritim Grafikleri matrisi */}
              <div className={CARD}>
              ...
              {/* Alt: Günlük Görevler ve Odak Seansları */}
              <div className={CARD}>
                {isToday && (
                  <div className="mb-5">
                    ...
                    {loading ? (
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        {todayTasks.length > 8 && (
                          <p className="text-[10.5px] text-[var(--text-faint)] mt-1">+{todayTasks.length - 8} görev daha</p>
                        )}
                      </div>
                    )}
                  </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              {/* Üst: AI Gün Sonu Raporu Özet Kartı */}
                ...
                {isToday && (
                  <div className="mt-5 pt-5 border-t border-black/5 dark:border-white/5 flex flex-col gap-2.5">
                    ...
                    <p className="text-[10.5px] leading-relaxed text-left text-[var(--text-faint)]">
                      ⚠️ <strong>Not:</strong> Bugün yapabileceğiniz görevleri yapıp işaretledikten sonra bu butona basın.
                      Tamamlayamadığınız görevler ve aksayan rutinler önümüzdeki günlere enerjinizi zorlamayacak şekilde
                      akıllıca dağıtılır ve yarının planlaması otomatik olarak tekrardan yapılır.
                    </p>
                    {endDayResult && (
              ...
              {/* Orta: AI Kotası + Hızlı İstatistikler */}
              <div className={CARD}>
                <p className="text-[11px] font-semibold uppercase tracking-[0.05em] text-left text-[var(--text-faint)] mb-3">
                  AI Kotası & Hızlı İstatistikler
                </p>
                {coachQuota && (
              ...
              <div className={CARD}>
                ...
                {selectedReport?.tomorrow_focus?.length > 0 ? (
                  ...
                  <p className="text-[12px] text-[var(--text-faint)] text-left">
                    Günlük raporunu hazırladığında yarının odak noktaları burada görünecek.
                  </p>
                )}
              </div>
            </div>
